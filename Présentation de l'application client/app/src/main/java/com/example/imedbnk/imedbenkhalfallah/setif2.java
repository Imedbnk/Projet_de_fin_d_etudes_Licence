...
public class setif2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setif2);
        ...
        View alertCustomDialog = LayoutInflater.from(setif2.this).inflate(R.layout.custom_dialog,null);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(setif2.this);

        View alertCustomDialog2 = LayoutInflater.from(setif2.this).inflate(R.layout.custom_dialog2,null);
        AlertDialog.Builder alertDialog2 = new AlertDialog.Builder(setif2.this);
        ...
        ok_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog2.show();
                dialog.cancel();
                Toast.makeText(setif2.this, "Sent succesfuly", Toast.LENGTH_SHORT).show();
            }
        });
