...
public class HotelsOran extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotels_oran);
        ...
        priceRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.RadioButton1) {
                    textViewA.setText("Prix: 133 €");
                } else if (checkedId == R.id.RadioButton2) {
                    textViewA.setText("Prix: 261 €");
                } else if (checkedId == R.id.RadioButton3) {
                    textViewA.setText("Prix: 405 €");
                }
            }
        });
        ...
        priceRadioGroup2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.RadioButton4) {
                    textViewB.setText("Prix: 147 €");
                } else if (checkedId == R.id.RadioButton5) {
                    textViewB.setText("Prix: 275 €");
                } else if (checkedId == R.id.RadioButton6) {
                    textViewB.setText("Prix: 419 €");
                }
            }
        });
        ...
        priceRadioGroup3.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.RadioButton7) {
                    textViewC.setText("Prix: 182 €");
                } else if (checkedId == R.id.RadioButton8) {
                    textViewC.setText("Prix: 310 €");
                } else if (checkedId == R.id.RadioButton9) {
                    textViewC.setText("Prix: 454 €");
                }
            }
        });
    ...
    public void login5() {
        Intent hotelalger1 = new Intent(this, oran1.class);
        startActivity(hotelalger1);
        finish();
    }

    public void login6() {
        Intent hotelalger2 = new Intent(this, oran2.class);
        startActivity(hotelalger2);
        finish();
    }

    public void login7() {
        Intent hotelalger3 = new Intent(this, oran3.class);
