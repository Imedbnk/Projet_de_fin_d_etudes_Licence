...
public class HotelsAlger extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotels_alger);
        ...
        priceRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.RadioButton1) {
                    textViewA.setText("Prix: 167 €");
                } else if (checkedId == R.id.RadioButton2) {
                    textViewA.setText("Prix: 295 €");
                } else if (checkedId == R.id.RadioButton3) {
                    textViewA.setText("Prix: 439 €");
                }
            }
        });
        ...
        priceRadioGroup2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.RadioButton4) {
                    textViewB.setText("Prix: 134 €");
                } else if (checkedId == R.id.RadioButton5) {
                    textViewB.setText("Prix: 262 €");
                } else if (checkedId == R.id.RadioButton6) {
                    textViewB.setText("Prix: 406 €");
                }
            }
        });
        ...
        priceRadioGroup3.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.RadioButton7) {
                    textViewC.setText("Prix: 90 €");
                } else if (checkedId == R.id.RadioButton8) {
                    textViewC.setText("Prix: 218 €");
                } else if (checkedId == R.id.RadioButton9) {
                    textViewC.setText("Prix: 362 €");
                }
            }
        });
    ...
    public void login5() {
        Intent hotelalger1 = new Intent(this, alger1.class);
        startActivity(hotelalger1);
        finish();
    }

    public void login6() {
        Intent hotelalger2 = new Intent(this, alger2.class);
        startActivity(hotelalger2);
        finish();
    }

    public void login7() {
        Intent hotelalger3 = new Intent(this, alger3.class);
