...
public class alger3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alger3);
        ...
        View alertCustomDialog = LayoutInflater.from(alger3.this).inflate(R.layout.custom_dialog,null);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(alger3.this);

        View alertCustomDialog2 = LayoutInflater.from(alger3.this).inflate(R.layout.custom_dialog2,null);
        AlertDialog.Builder alertDialog2 = new AlertDialog.Builder(alger3.this);
        ...
        ok_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog2.show();
                dialog.cancel();
                Toast.makeText(alger3.this, "Sent succesfuly", Toast.LENGTH_SHORT).show();
            }
        });
