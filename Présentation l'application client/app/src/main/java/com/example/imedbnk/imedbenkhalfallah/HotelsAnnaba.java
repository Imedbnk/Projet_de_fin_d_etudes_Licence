...
public class HotelsAnnaba extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotels_annaba);
        ...
        priceRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.RadioButton1) {
                    textViewA.setText("Prix: 158 €");
                } else if (checkedId == R.id.RadioButton2) {
                    textViewA.setText("Prix: 286 €");
                } else if (checkedId == R.id.RadioButton3) {
                    textViewA.setText("Prix: 430 €");
                }
            }
        });
        ...
        priceRadioGroup2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.RadioButton4) {
                    textViewB.setText("Prix: 79 €");
                } else if (checkedId == R.id.RadioButton5) {
                    textViewB.setText("Prix: 207 €");
                } else if (checkedId == R.id.RadioButton6) {
                    textViewB.setText("Prix: 351 €");
                }
            }
        });
        ...
        priceRadioGroup3.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.RadioButton7) {
                    textViewC.setText("Prix: 57 €");
                } else if (checkedId == R.id.RadioButton8) {
                    textViewC.setText("Prix: 185 €");
                } else if (checkedId == R.id.RadioButton9) {
                    textViewC.setText("Prix: 329 €");
                }
            }
        });
    ...
    public void login5() {
        Intent hotelalger1 = new Intent(this, annaba1.class);
        startActivity(hotelalger1);
        finish();
    }

    public void login6() {
        Intent hotelalger2 = new Intent(this, annaba2.class);
        startActivity(hotelalger2);
        finish();
    }

    public void login7() {
        Intent hotelalger3 = new Intent(this, annaba3.class);
