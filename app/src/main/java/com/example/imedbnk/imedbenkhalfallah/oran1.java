...
public class oran1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oran1);
        ...
        View alertCustomDialog = LayoutInflater.from(oran1.this).inflate(R.layout.custom_dialog,null);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(oran1.this);

        View alertCustomDialog2 = LayoutInflater.from(oran1.this).inflate(R.layout.custom_dialog2,null);
        AlertDialog.Builder alertDialog2 = new AlertDialog.Builder(oran1.this);
        ...
        ok_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog2.show();
                dialog.cancel();
                Toast.makeText(oran1.this, "Sent succesfuly", Toast.LENGTH_SHORT).show();
            }
        });
